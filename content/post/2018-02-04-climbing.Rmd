...
"The search begins with start values..."
...
"Numerical methods are the mathematical equivalent of how you would find the top of a hill if you were blindfolded and..."
...
"From the start position, the slope of the likelihood function and the rate of change in the slope determine the next guess for the parameters. The process continues to iterate until the maximum of the likelihood function is found, called, convergence, ...

```{r optimization, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
optimization <- optimx(s_val, logLikelihood, method = 'BFGS', mX = predictors, vY = outcome, hessian=TRUE)
```
