...
[^1]: He is also the author of a several useful `R` packages such as `rio`, `margins`, and `tabulizer`. Check his github [repo](https://github.com/leeper).  
